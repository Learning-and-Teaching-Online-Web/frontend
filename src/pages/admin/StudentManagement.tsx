                    ...
                    <tr key={student.user_id}>
                      <td style={{ fontWeight: 600 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                          ...
                          />
                          <span>{student.full_name || student.email?.split('@')[0] || 'Người dùng'}</span>
                        </div>
                      </td>
                      <td>{student.email}</td>
        ...
        <div className="modal-overlay">
          <div className="modal-card" style={{ maxWidth: '600px', background: '#fff', borderRadius: '16px', padding: '24px' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', alignItems: 'center', marginBottom: '20px', paddingBottom: '16px', borderBottom: '1px solid #f1f5f9' }}>
              ...
              />
              <div>
                <h4 style={{ margin: '0 0 4px 0', fontSize: '18px', color: '#0f172a' }}>{selectedStudent.full_name || selectedStudent.email?.split('@')[0] || 'Người dùng'}</h4>
