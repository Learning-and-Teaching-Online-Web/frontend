  ...
  return (
    <div className="section-card" style={{ padding: '24px', backgroundColor: '#f8fafc' }}>
      <div className="section-header" style={{ marginBottom: '20px' }}>
        <h2>Lịch Giảng Dạy Online</h2>
        <p style={{ color: '#64748b', fontSize: '14px', margin: 0 }}>Quản lý chi tiết danh sách và thời gian biểu các buổi giảng dạy theo từng khóa học và học viên.</p>
      </div>
      ...
      {!hasData ? (
        <div style={{ textAlign: 'center', padding: '60px 20px', background: '#fff', borderRadius: '16px', border: '1px dashed #cbd5e1' }}>
          ...
          <h3 style={{ margin: '0 0 8px 0', color: '#475569' }}>Chưa có lịch dạy</h3>
          <p style={{ margin: 0, color: '#94a3b8' }}>Hiện chưa có lịch giảng dạy nào được khởi tạo từ các khóa học của bạn.</p>
        </div>
      ) : (
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div>
                      ...
                      <p style={{ margin: '4px 0 0 0', fontSize: '13px', color: '#64748b' }}>
                        {totalStudents} Học viên • {totalSessionsInCourse} Tổng buổi dạy
                      </p>
                    </div>
                  </div>
                  <div>
                          ...
                          >
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                              ...
                              <div>
                                ...
                                <span style={{ fontSize: '12px', color: '#8b5cf6', fontWeight: 500 }}>{sessions.length} Buổi dạy</span>
                              </div>
                            </div>
                            <div>
                          ...
                          {isStudentExpanded && (
                            <div style={{ padding: '0', overflowX: 'auto' }}>
                              <table className="db-table" style={{ margin: 0, border: 'none', borderTop: 'none', borderRadius: 0, width: '100%' }}>
                                <thead>
                                  <tr>
                                    <th style={{ background: '#f8fafc', padding: '12px 16px', fontSize: '13px' }}>Buổi dạy</th>
                                    ...
                                    <th style={{ background: '#f8fafc', padding: '12px 16px', fontSize: '13px' }}>Phòng / Link dạy</th>
